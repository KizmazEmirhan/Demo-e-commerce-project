<template>
  <div id="header" class="flex items-center justify-evenly my-4">
    <div id="brand-name" class="font-bold text-xl">
      <a href="/">Demo Brand</a>
    </div>

    <ul id="rooting-buttons" class="flex gap-6">
      <li>
    ...
    <ul id="registiration-section" class="flex gap-6 items-center">
      <li>
        <button class="flex gap-3 items-center">
          ...
          <div class="text-[#23A6F0] text-sm">Log in/Register</div>
        </button>
      </li>
      <li>
        <button>
