    ...
    <div id="footer-section" class="w-full">
      <div id="brandName" class="flex justify-center bg-[#FAFAFA] lg:p-28 p-4">
        <div class="container flex justify-between items-center">
          ...
          <div id="social-media" class="flex gap-5">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#4267B2" class="bi bi-facebook"
              viewBox="0 0 16 16">
              <path
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none"
              class="bi bi-instagram hover:fill-gradient" viewBox="0 0 16 16">
              <defs>
      ...
      <div class="flex justify-center p-4">
        <div id="other informations" class="container py-8 flex justify-between">
          ...
          <ul id="features" class="flex flex-col gap-4">
          ...
          <ul id="resources" class="flex flex-col gap-4">
